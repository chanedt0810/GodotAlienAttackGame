...
func _ready() -> void:
	...
	enemy_spawner.connect("path_enemy_spawned", _on_enemy_spawner_path_enemy_spawned)
...
func _on_enemy_spawner_path_enemy_spawned(path_enemy_instance: Node) -> void:
	# Add the path enemy instance to the scene
